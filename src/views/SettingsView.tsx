...
import { Plus, Trash2, Upload, Settings as SettingsIcon } from 'lucide-react';
...
export function SettingsView() {
  ...
  const handleAddReciter = async () => {
    ...
    const reciter = {
      ...
      name: newReciterName,
      style: 'Custom',
      serverUrl: newReciterUrl.endsWith('/') ? newReciterUrl : newReciterUrl + '/',
    };
  ...
  const handleUploadVideo = async () => {
    ...
    const updated = [...customVideos, { id, name: videoName }];
        ...
        <section className="bg-[#131722]/80 backdrop-blur-xl border border-slate-800/50 rounded-3xl p-6 lg:p-8">
          ...
          <div className="flex flex-col md:flex-row gap-4 mb-6">
            <input 
              ...
              className="flex-1 bg-[#030712] border border-slate-700 rounded-xl px-4 py-3 text-white focus:border-teal-500 focus:ring-1 focus:ring-teal-500 outline-none transition-all"
            />
            <input 
              type="text" 
        ...
        <section className="bg-[#131722]/80 backdrop-blur-xl border border-slate-800/50 rounded-3xl p-6 lg:p-8">
          ...
          <div className="flex flex-col md:flex-row gap-4 mb-6">
            ...
            <div className="flex-1 relative">
              ...
              />
              <div className="bg-[#030712] border border-slate-700 rounded-xl px-4 py-3 text-white flex items-center justify-between">
